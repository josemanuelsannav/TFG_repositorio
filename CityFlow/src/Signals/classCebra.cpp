...
namespace CityFlow
{
    ...
    double ClassCebra::affectVehicle(Vehicle &vehicle , double v )
    {
        ...
        {
            if ((this->pos_x - 24 <= vehicle.getPoint().x && this->pos_x - 12 >= vehicle.getPoint().x && this->pos_y - 12 <= vehicle.getPoint().y && this->pos_y >= vehicle.getPoint().y) || // carretera horizontal izquierda a derecha
                (this->pos_x <= vehicle.getPoint().x && this->pos_x + 12 >= vehicle.getPoint().x && this->pos_y - 30 <= vehicle.getPoint().y && this->pos_y - 12 >= vehicle.getPoint().y) || // carretera vertical abajo a arriba
                (this->pos_x + 12 <= vehicle.getPoint().x && this->pos_x + 24 >= vehicle.getPoint().x && this->pos_y <= vehicle.getPoint().y && this->pos_y + 12 >= vehicle.getPoint().y) || // carretera horizontal derecha a izquierda
                (this->pos_x - 12 <= vehicle.getPoint().x && this->pos_x >= vehicle.getPoint().x && this->pos_y + 12 <= vehicle.getPoint().y && this->pos_y + 30 >= vehicle.getPoint().y))   // carretera vertical arriba a abajo {
            {
